...
*  ************************************************************************ */
#define CMT2300A_SetGpio1In()           SET_GPIO_IN_RIS(CMT_GPIO1_GPIO)
#define CMT2300A_SetGpio2In()           SET_GPIO_IN_RISFAL(CMT_GPIO2_GPIO)
...
#define CMT2300A_GetTickCount()         TickCount
/* ************************************************************************ */
